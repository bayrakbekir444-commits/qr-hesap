...
const plans = [
  {
    ...
    features: ['1 restoran', '5 masa', 'QR menü', 'Sipariş alma', 'Garson çağırma'],
    cta: 'Hemen Başla',
    popular: false,
  },
  {
    ...
    features: ['Sınırsız masa', 'Detaylı raporlar', 'PDF export', 'Çoklu dil', 'Çoklu personel', 'Öncelikli destek'],
    cta: 'Pro\'ya Geç',
    popular: true,
  },
  {
    ...
    features: ['Sınırsız restoran', 'Merkezi yönetim', 'API erişimi', 'Özel entegrasyon', 'Birebir destek'],
    cta: 'İletişime Geç',
    popular: false,
  },
];
